...
git commit -m "ci: add Codex GitHub Action workflow"
```
...
**IMPORTANT**: When working on any feature or improvement, Codex MUST follow this systematic workflow to ensure accuracy and code quality:
